...
from handmocap.mocap_utils.coordconv import convert_smpl_to_bbox, convert_bbox_to_oriIm


class HandMocap:
    def __init__(self, regressor_checkpoint, smpl_dir=None, device = torch.device('cuda') , use_smplx = False):
        #For image transform
