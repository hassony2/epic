...
from epic.boxutils import epic_box_to_norm, get_center_scale, get_closest, extend_props, extend_labels
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--fit_folder",
        default=
        "/mnt/disks/myssd/code/handpose/obman_train/results/2019_01_22_parallel"
    )
    parser.add_argument(
        "--rec_folder",
    ...
    fit_files = [
        os.path.join(fit_folder, rec_file)
        for rec_file in os.listdir(fit_folder)
    ]
