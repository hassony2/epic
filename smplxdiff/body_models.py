...
class SMPL(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.register_buffer(
            "posedirs", to_tensor(to_np(posedirs), dtype=dtype)
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        batch_size = max(
            betas.shape[0], global_orient.shape[0], body_pose.shape[0]
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if create_left_hand_pose:
            ...
            left_hand_pose_param = nn.Parameter(
                default_lhand_pose, requires_grad=True
            )
        ...
        if create_right_hand_pose:
            ...
            right_hand_pose_param = nn.Parameter(
                default_rhand_pose, requires_grad=True
            )
    ...
    def forward(
        ...
        **kwargs,
        ...
        left_hand_pose = (
            ...
            else self.left_hand_pose
        )
        right_hand_pose = (
            right_hand_pose
            if right_hand_pose is not None
            else self.right_hand_pose
        )
...
class SMPLX(SMPLH):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if create_expression:
            ...
            expression_param = nn.Parameter(
                default_expression, requires_grad=True
            )
    ...
    def forward(
        ...
        **kwargs,
        ...
        lmk_faces_idx = (
            self.lmk_faces_idx.unsqueeze(dim=0)
            .expand(batch_size, -1)
            .contiguous()
        )
...
class FLAME(SMPL):
    ...
    def forward(
        ...
        **kwargs,
        ...
        batch_size = max(
            betas.shape[0], global_orient.shape[0], jaw_pose.shape[0]
        )
        # Concatenate the shape and expression coefficients
        scale = int(batch_size / betas.shape[0])
        if scale > 1:
